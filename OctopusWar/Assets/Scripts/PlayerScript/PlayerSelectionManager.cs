...
public class PlayerSelectionManager : MonoBehaviour
{
    ...
    public void OnSelectButtonClicked()
    {
        ...
        ExitGames.Client.Photon.Hashtable playerSelectionProp = new ExitGames.Client.Photon.Hashtable { {MultiplayerGame.PLAYER_SELECTION_NUMBER, playerSelectionNumber } };
